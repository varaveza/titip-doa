      ...
      <div className="relative z-10 w-full max-w-md flex flex-col px-4">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden">
          <div className="pt-6 sm:pt-8 px-4 sm:px-6 pb-2 text-center">
            <h1 className="text-xl sm:text-2xl font-bold text-white mb-1">Daftar Akun</h1>
          </div>
          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="full_name" className="block text-xs font-medium text-emerald-200 uppercase tracking-wider mb-1.5 ml-1">
                  Nama Lengkap
                </label>
                <input
                  type="text"
            ...
            <div className="text-center">
              <Link to="/login" className="text-emerald-200 text-xs sm:text-sm hover:text-white underline">
